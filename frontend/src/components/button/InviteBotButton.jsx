...
export default function InviteBotButton() {
  ...
  const INVITE_URL = `https://discord.com/oauth2/authorize?client_id=1394227164144074862&permissions=274877921280&scope=bot&redirect_uri=${INVITE_REDIRECT_URI}&response_type=code`;
